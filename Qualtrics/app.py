...
def convening_basics():
    if request.method == 'POST':
        session['convening_basics'] = request.form.to_dict()
        #print(session['convening_basics'])
...
def convening_formats_and_spaces():
    if request.method == 'POST':
        session['convening_formats_and_spaces'] = request.form.to_dict()
...
def space_photos():
    if request.method == 'POST':
        session['space_photos'] = request.form.to_dict()
...
def times_and_counts():
    if request.method == 'POST':
        session['times_and_counts'] = request.form.to_dict()
...
def procedures_and_norms():
    if request.method == 'POST':
        session['procedures_and_norms'] = request.form.to_dict()
...
def activities():
    if request.method == 'POST':
        session['activities'] = request.form.to_dict()
...
def organizing_and_mobilizing():
    if request.method == 'POST':
        session['organizing_and_mobilizing'] = request.form.to_dict()
...
def public_sphere():
    if request.method == 'POST':
        session['public_sphere'] = request.form.to_dict()
...
def decision_making():
    if request.method == 'POST':
        session['decision_making'] = request.form.to_dict()
...
def planning_strategizing():
    if request.method == 'POST':
        session['planning_strategizing'] = request.form.to_dict()
...
def leaders():
    if request.method == 'POST':
        session['leaders'] = request.form.to_dict()
